...
class CacheTest extends PHPUnit_Framework_TestCase 
{
    ...
    public function setUp()
    {
        ...
        $this->extension = new MageTool_Tool_MageApp_Provider_Core_Cache;
    }
    ...
    {
        $this->assertEquals( $this->extension->getName(), 'MageCoreCache', 'The providor does not return the expected string name' );
    } // getNameShouldReturnString
